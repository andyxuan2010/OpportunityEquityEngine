...
const navTranslations = {
  en: { "nav.home":"Home", "nav.solutions":"Project", "nav.projects":"Guides", "nav.docs":"Library", "nav.repos":"GitHub", "nav.contact":"README", "pdf.download":"Download PDF", "pdf.generating":"Generating PDF…", "pdf.error":"Could not generate the PDF.", "md.download":"Download Markdown", "md.generating":"Downloading Markdown…", "md.error":"Could not download the Markdown file." },
  fr: { "nav.home":"Accueil", "nav.solutions":"Projet", "nav.projects":"Guides", "nav.docs":"Bibliothèque", "nav.repos":"GitHub", "nav.contact":"README", "pdf.download":"Télécharger le PDF", "pdf.generating":"Génération du PDF…", "pdf.error":"Impossible de générer le PDF.", "md.download":"Télécharger le Markdown", "md.generating":"Téléchargement du Markdown…", "md.error":"Impossible de télécharger le fichier Markdown." },
  zh: { "nav.home":"首页", "nav.solutions":"项目", "nav.projects":"指南", "nav.docs":"知识库", "nav.repos":"GitHub", "nav.contact":"README", "pdf.download":"下载 PDF", "pdf.generating":"正在生成 PDF…", "pdf.error":"无法生成 PDF。", "md.download":"下载 Markdown", "md.generating":"正在下载 Markdown…", "md.error":"无法下载 Markdown 文件。" }
};
const docsUiTranslations = {
  en: {
    "docs.all": "All",
    "docs.library": "Opportunity Equity Engine",
    ...
    "docs.libraryMap": "Opportunity library map",
    ...
    "docs.indexEyebrow": "Opportunity Equity Engine",
    "docs.indexTitle": "A clearer path to opportunity.",
    "docs.indexIntro": "Student-centered Markdown guides organized across eleven focused categories, from project vision and architecture to research, implementation, and opportunity resources.",
    "docs.solarTitle": "Opportunity knowledge map",
    "docs.solarDescription": "documentation categories orbit a central sphere containing the count of Markdown guides.",
  ...
  fr: {
    "docs.all": "Tous",
    "docs.library": "Moteur d’équité des opportunités",
    ...
    "docs.libraryMap": "Carte de la bibliothèque",
    ...
    "docs.indexEyebrow": "Moteur d’équité des opportunités",
    "docs.indexTitle": "Un chemin plus clair vers les opportunités.",
    "docs.indexIntro": "Guides Markdown centrés sur les élèves et organisés en onze catégories, de la vision du projet à l’architecture, la recherche, l’implémentation et les ressources.",
    "docs.solarTitle": "Carte des connaissances sur les opportunités",
    "docs.solarDescription": "catégories de documentation orbitent autour d’une sphère centrale contenant le nombre de guides Markdown.",
  ...
  zh: {
    ...
    "docs.indexEyebrow": "机会公平引擎",
    "docs.indexTitle": "通往机会的清晰路径。",
    "docs.indexIntro": "以学生为中心的 Markdown 指南分为十一类，涵盖项目愿景、架构、研究、实现和机会资源。",
    "docs.solarTitle": "机会知识地图",
    "docs.solarDescription": "个文档分类围绕着包含 Markdown 指南数量的中心球运行。",
...
const docsCategoryTranslations = {
  ...
  fr: {
    ...
    "00-start-here": "Commencer ici",
    "01-initiative": "Vision du projet",
    "02-architecture": "Architecture",
    "03-student-guides": "Guides pour les élèves",
    "04-delivery": "Plan de livraison",
    "05-build": "Guide de construction",
    "06-demo": "Livrables de démonstration",
    "07-research-and-validation": "Recherche et validation",
    "08-student-toolkit": "Boîte à outils",
    "09-showcase-and-reflection": "Présentation et réflexion",
    "10-opportunity-sources": "Ressources sur les opportunités"
  },
  zh: {
    ...
    "03-student-guides": "学生指南",
    "04-delivery": "交付计划",
    "05-build": "构建指南",
    "06-demo": "演示交付物",
    "07-research-and-validation": "研究与验证",
    "08-student-toolkit": "学生工具箱",
    "09-showcase-and-reflection": "展示与反思",
    "10-opportunity-sources": "机会资源"
  }
};
...
function parseDocument(source) {
  ...
  source = source.replace(/^##\s+(?:完整同步参考|Référence complète synchronisée)\s*\r?\n[\s\S]*?^<\/details>\s*$/gmi, "");
...
function resolveArticleImageSources(target, articlePath) {
  ...
  target.querySelectorAll("img[src]").forEach(image => {
    ...
    const resolved = /^docs\//i.test(source)
