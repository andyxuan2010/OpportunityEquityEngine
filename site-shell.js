(() => {
  ...
  const shellTranslations = {
    en: {
      ...
      "menu.opportunityEquityEngine": "Opportunity Equity Engine",
  ...
  nav.innerHTML = `
    ...
    <div class="nav-links" id="site-navigation">
      ...
      <details class="nav-menu nav-item nav-item-focus"><summary class="${activeClass("focus").trim()}"><span data-i18n="nav.solutions">Project</span><span class="nav-chevron">▾</span></summary><div class="nav-dropdown"><a href="${base}index.html#more-opportunities">Project overview</a><a href="${base}index.html#product-experience">Product experience</a><a href="${base}index.html#trust-by-design">Trust by design</a><a href="${base}index.html#documentation-map">Documentation map</a></div></details>
      <details class="nav-menu nav-item nav-item-projects"><summary><span data-i18n="nav.projects">Guides</span><span class="nav-chevron">▾</span></summary><div class="nav-dropdown"><a href="${base}docs/index.html">All documentation</a><a href="${base}docs/article.html?article=start-here">Start here</a><a href="${base}docs/article.html?article=beginner-project-guide">Beginner project guide</a><a href="${base}docs/article.html?article=demo-implementation-guide">Demo implementation</a><a href="${base}docs/article.html?article=opportunity-equity-engine-600-sources">Opportunity resources</a></div></details>
      <details class="nav-menu nav-item nav-item-library"><summary class="${activeClass("docs").trim()}"><span data-i18n="nav.docs">Library</span><span class="nav-chevron">▾</span></summary><div class="nav-dropdown" data-docs-menu><a href="${base}docs/index.html" data-shell-i18n="menu.openEngineeringLibrary">Open documentation library</a></div></details>
      <details class="nav-menu nav-item nav-item-repos"><summary><span data-i18n="nav.repos">GitHub</span><span class="nav-chevron">▾</span></summary><div class="nav-dropdown"><a href="https://github.com/andyxuan2010/OpportunityEquityEngine" target="_blank" rel="noreferrer" data-shell-i18n="menu.majorRepositories">This repository</a><a href="https://github.com/andyxuan2010?tab=repositories" target="_blank" rel="noreferrer" data-shell-i18n="menu.allGithubRepositories">All GitHub repositories ↗</a></div></details>
      <a class="nav-item nav-item-contact${activeClass("contact")}" href="${base}README.md" data-i18n="nav.contact">README</a>
